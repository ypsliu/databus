...
import cn.rongcapital.mc2.data.bus.tools.mock.scenario.mocker.JourneyMovedMocker;
...
@Component
public class MockJourneyMovedProcess extends AbstractAsyncProcessor {

	@Value("${mock.journey.count:10}")
	private Integer journeyCount;

	@Autowired
	private JourneyMovedMocker journeyMovedMocker;
	...
	public void asyncProcess(Exchange exchange) {
		...
		for (int i = 0; i < journeyCount; i++) {
			...
			journeyInfo.accept(journeyMovedMocker);
