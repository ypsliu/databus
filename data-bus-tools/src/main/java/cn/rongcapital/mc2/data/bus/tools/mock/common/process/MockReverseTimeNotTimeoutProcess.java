...
import cn.rongcapital.mc2.data.bus.tools.mock.common.service.ReverseTimeService;
import cn.rongcapital.mc2.data.common.camel.AbstractAsyncProcessor;

@Component
public class MockReverseTimeNotTimeoutProcess extends AbstractAsyncProcessor {

	@Autowired
	private ReverseTimeService reverseTimeService;
	...
	public void asyncProcess(Exchange exchange) {
		...
		reverseTimeService.settingNotTimeout(startTime, behaviorInfoList);
